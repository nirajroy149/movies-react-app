...
function Card({ key, poster, media_type, vote_average, title, r_date }) {
  const img_300 = "https://images.tmdb.org/t/p/w300";
  const unavailable = "https://www.movienewz.com/img/films/poster-holder.jpg";

  return (
    <div className="hover:cursor-pointer hover:bg-white hover:text-black transition ease-linear relative text-white flex flex-col w-[200px] sm:w-[220px] p-1 bg-gray-700 m-3 rounded min-h-[93.471px]">
      <img
